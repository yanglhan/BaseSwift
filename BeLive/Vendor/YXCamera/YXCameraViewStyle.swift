...
/// 扫码区域4个角位置类型
public enum YXCameraPhotoframeAngleStyle {
...
public struct YXCameraViewStyle {
    ...
    /// 扫码区域的4个角类型
    public var photoframeAngleStyle = YXCameraPhotoframeAngleStyle.Outer
