...
//        langBundle = [NSBundle bundleWithPath:[[NSBundle mj_refreshBundle] pathForResource:language ofType:@"lproj"]];
//    }
//    value = [langBundle localizedStringForKey:key value:value table:nil];
//    NSLog(@"mj_localizedStringForKey = %@", value);
...
{
    if (langBundle == nil) {
        NSString *language =language = [NSLocale preferredLanguages].firstObject;
