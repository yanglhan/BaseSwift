...
//  Growdex
//
//  Created by TEZWEZ on 2019/10/31.
...
class XTouchLabel: UIView {
    ...
    public func configContent(aText: String,
        ...
        attributedStr.addAttributes([NSAttributedString.Key.foregroundColor: aColor, NSAttributedString.Key.font: aFont], range: NSRange(location: 0, length: aText.length))
